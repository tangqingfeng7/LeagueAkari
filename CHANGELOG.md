...
- 游戏结束时自动保存对局分析数据到本地数据库，包括玩家战绩分析、队伍分析、预组队信息等。

- 新增客户端优化功能：可禁用挑战横幅和主页广告，提高客户端流畅性和性能。

## 优化

- 对局分析数据现在支持所有游戏模式，包括训练模式。

- 改进了游戏结束检测机制，支持 WaitingForStats、PreEndOfGame、EndOfGame 等多种结束状态。
...
- 好友工具新增快速清理功能，可删除从未一起玩过的好友。

- 好友工具新增慢速清理功能，可删除超过1年未一起玩的好友。

- 好友工具新增自定义筛选功能，支持按天数筛选并批量删除不活跃好友。

- 好友工具新增全选和清除选择功能，方便批量管理好友。

## 优化

- 为战绩分析和预组队计算添加缓存机制，大幅提升性能。

- 集成性能监控系统，自动追踪耗时操作并输出警告。

- 新增工具库：缓存助手、错误处理器、性能监视器、数据处理器。

- 优化了 ARAM 自动选择策略的代码结构。
